...
export default function Education() {
  return (
    <section id="education" className="py-12 sm:py-16 md:py-24 relative overflow-hidden bg-slate-950/10 border-b border-white/5">
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        
        {/* Header Block */}
        <div className="max-w-3xl mb-8 sm:mb-12 md:mb-16 text-left">
          <p className="text-sm font-bold tracking-widest text-[#4F6EF7] uppercase mb-2 sm:mb-3">
            ACADEMICS
          </p>
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-10 gap-0 items-stretch">
            ...
            <div className="md:col-span-3 p-5 sm:p-8 flex flex-col justify-center border-b md:border-b-0 md:border-r border-white/5 text-left bg-slate-900/20">
              <div className="w-10 h-10 rounded-xl bg-slate-950 border border-white/5 flex items-center justify-center mb-4 sm:mb-5 shadow-inner">
                <GraduationCap size={20} className="text-[#4F6EF7]" />
              </div>
              <h3 className="text-lg sm:text-xl font-bold text-white leading-tight">
                Bachelor's Degree
              </h3>
              <p className="text-xs font-semibold text-[#4F6EF7] uppercase tracking-wider mt-1 mb-4 sm:mb-6">
                INFORMATION TECHNOLOGY
              </p>

              <div className="space-y-2.5 sm:space-y-3 text-slate-400 text-xs font-medium">
            ...
            <div className="md:col-span-7 p-5 sm:p-8 md:p-10 text-left flex flex-col justify-center space-y-4 sm:space-y-6">
              <div>
